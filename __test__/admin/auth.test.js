...
beforeAll(async function (){
  try {
    ...
    inserted_user = await user.insertOne({
      username: 'Mario_Ryan73',
      password: 'hUAcR7lxm3nLplm',
      email: 'Carol_Kling@hotmail.com',
      name: 'Juana Durgan',
      mobileNo: '273-267-5976 x5448',
      userType: 939,
      resetPasswordLink: {},
      loginRetryLimit: 855,
      loginReactiveTime: '2022-12-06T14:57:26.699Z',
      id: '622f113054dc685a59519e30'
    });
  }
  catch (err) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Isaac.Ziemann',
        'password':'2T5vhjF4IGaWSN8',
        'email':'Florence.Thiel@gmail.com',
        'name':'Willie Zboncak',
        'mobileNo':'1-701-675-6074',
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    ...
    let user = await request(app)
      .post('/admin/auth/forgot-password')
      .send({ 'email':'Florence.Thiel@gmail.com', });
