...
beforeAll(async function (){
  try {
    ...
    inserted_user = await user.insertOne({
      username: 'Ciara39',
      password: 'FAZXfrZWD2hcIUp',
      email: 'Norval95@yahoo.com',
      name: 'Willard Macejkovic',
      mobileNo: '349-746-0957',
      userType: 759,
      resetPasswordLink: {},
      loginRetryLimit: 164,
      loginReactiveTime: '2022-09-09T08:39:39.787Z',
      id: '622f113054dc685a59519e5a'
    });
  }
  catch (err) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Keven7',
        'password':'qxW9jPTQ9hMVDnr',
        'email':'Tremayne.Fadel21@gmail.com',
        'name':'Patti Christiansen V',
        'mobileNo':'632.312.0539',
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    ...
    let user = await request(app)
      .post('/device/auth/forgot-password')
      .send({ 'email':'Tremayne.Fadel21@gmail.com', });
